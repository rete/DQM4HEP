...
#ifndef DQM4HEP_HTTPSTATUSCODES_H
#define DQM4HEP_HTTPSTATUSCODES_H
...
namespace dqm4hep {
  ...
  namespace net {
    ...
    inline bool isInformational(HttpStatusCode code) { return isInformational(static_cast<int>(code)); } //!< \overload
    inline bool isSuccessful(HttpStatusCode code)    { return isSuccessful(static_cast<int>(code)); }    //!< \overload
    inline bool isRedirection(HttpStatusCode code)   { return isRedirection(static_cast<int>(code)); }   //!< \overload
    inline bool isClientError(HttpStatusCode code)   { return isClientError(static_cast<int>(code)); }   //!< \overload
    inline bool isServerError(HttpStatusCode code)   { return isServerError(static_cast<int>(code)); }   //!< \overload
    inline bool isError(HttpStatusCode code)         { return isError(static_cast<int>(code)); }         //!< \overload
     ...
     * if no standard phrase for the given \p code is known.
     */
    inline std::string reasonPhrase(HttpStatusCode code) {
...
#endif /* DQM4HEP_HTTPSTATUSCODES_H */
